...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFueWFrMTMiLCJhIjoiY2xicDQycnMxMTdwMTNvcHE5aDFuM2R6ZyJ9.dKRo8pFtUZmJfMG2nyvS5w';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/danyak13/clbp46qpy000k14mshyui6a6d',
    // style URL
    center: [37.622217676479636, 55.75285478307421],
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u044B"));
            }
            _context.next = 11;
            break;
          case 8:
